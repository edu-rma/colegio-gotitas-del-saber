...
public class DashboarController implements Initializable {
    ...
    public DashboarController(DashboarService dashboarService, SceneManager sceneManager) {
    ...
    private void handleLoadTablestuden()throws Exception{
        fbcolumnid.setCellValueFactory(new PropertyValueFactory<>("idEstudainte"));
        ...
        tvEstudiante.setItems(dashboarService.listStudent());
    }
}
